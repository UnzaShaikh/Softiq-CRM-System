...
export default function AddCustomerPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    // Simulate API call with dummy data (no backend yet)
    ...
    <DashboardLayout>
      <div style={{ maxWidth: "720px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "24px" }}>
          <button
            ...
            style={{
              ...
              color: "#64748b", fontSize: "0.875rem", fontFamily: "inherit",
              padding: "0 0 12px", transition: "color 0.15s",
            }}
        ...
        <div style={{
          ...
          borderRadius: "14px", boxShadow: "0 1px 4px rgba(0,0,0,0.05)",
          overflow: "hidden",
        }}>
            ...
            <div style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "20px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <FormField
                  ...
                  placeholder="e.g. ahmed@example.com" required
                />
                <FormField
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  ...
                  fontFamily: "inherit", opacity: loading || success ? 0.75 : 1,
