...
import { Lead, LeadStatus, ApiLeadList, toLead } from "@/data/leads";
...
export default function LeadsPage() {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      const [all, nw, contacted, qualified] = await Promise.all([
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
        ...
        >
          ...
          >
            ...
            >
              {(["All", "New", "Contacted", "Qualified", "Lost"] as FilterStatus[]).map((tab) => (
                <button
                  key={tab}
                  ...
                  {tab !== "All" && (
                    <span
                      style={{
                        ...
                        height: 6,
                        borderRadius: "50%",
                        background: STATUS_COLORS[tab as LeadStatus],
                        marginRight: 5,
